...
const faqs = [
	...
	},
	{
		...
		answer:
			'Our free plan allows conversions of files up to 100MB in size. For larger files, you may want to consider our premium plans which support files up to 2GB.'
	},
	{
